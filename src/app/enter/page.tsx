    ...
    <div className="flex min-h-full flex-col bg-[var(--arth-n00)]">
      ...
      <main className="mx-auto flex w-full max-w-[1440px] flex-1 flex-col px-8 py-16">
        ...
        <p className="mt-4 max-w-[68ch] text-[var(--arth-n60)]">
          What you are testing: one telecalling department. Today, On a call, My enquiries, the enquiry record, Search, Notifications, My profile. Every enquiry has an owner and a clock. Telephony and scores are the next release.
        </p>
